(defvar tat/window-close-delay
  "30" "The time to show the result window after the async process finish execution, measured in second. This is a string, so if you change this value, please set it as a string.")
